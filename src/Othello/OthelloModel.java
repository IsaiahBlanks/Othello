...
public class OthelloModel implements OthelloMain.OthelloModelInterface {
    ...
    public OthelloModel(SquareStates[][] board) {
        setupCustomBoard(board);
        whoseTurn = false;
    }
    ...
    private void setupCustomBoard(SquareStates[][] board) {
        othelloBoard = board;
    }
    ...
    public int[] checkForBestMove() {
        return null; //This method is only needed for the AI model
    }
    ...
    public boolean getGameMode() {
        return false; //Not AI mode, return false
    }
